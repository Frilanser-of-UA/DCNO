...
else if (isMobile.any() || window.innerWidth > 1024) {
...
// search
let inputSearch = document.querySelector('.dc-search .form-control');
let inputWrap = document.querySelector('.dc-search-row');
let btnClose = inputWrap.querySelector('.close');
